...
public class ServiceProgressPresenter extends BasePresenter<ServiceProgressView> {

    public void getServiceRequestsOfCelebrity(String lang,String header, CelebrityServiceRequest request) {
        Disposable disposable = PSRService.getInstance(lang,header).getServiceRequestsOfCelebrity(request)
