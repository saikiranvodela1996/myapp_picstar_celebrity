...
public class CompressMainActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                VideoCompress.compressVideoLow(tv_input.getText().toString(), destPath, new VideoCompress.CompressListener() {
                    ...
                    public void onStart() {
                        ...
                        Util.writeFile(CompressMainActivity.this, "Start at: " + new SimpleDateFormat("HH:mm:ss", getLocale()).format(new Date()) + "\n");
                    }
                    ...
                    public void onSuccess() {
                        ...
                        Util.writeFile(CompressMainActivity.this, "End at: " + new SimpleDateFormat("HH:mm:ss", getLocale()).format(new Date()) + "\n");
                        Util.writeFile(CompressMainActivity.this, "Total: " + ((endTime - startTime)/1000) + "s" + "\n");
                        Util.writeFile(CompressMainActivity.this);
                    }
                    ...
                    public void onFail() {
                        ...
                        pb_compress.setVisibility(View.INVISIBLE);
                        endTime = System.currentTimeMillis();
                        Util.writeFile(CompressMainActivity.this, "Failed Compress!!!" + new SimpleDateFormat("HH:mm:ss", getLocale()).format(new Date()));
                    }
