...
public class FullScreenVideoView extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  Uri uri=Uri.parse("content://com.android.providers.media.documents/document/video%3A158522");
        ...
        simpleExoPlayer = ExoPlayerFactory.newSimpleInstance(FullScreenVideoView.this, trackSelector, loadControl);
