package com.devrabbit.picstarcelebrity.videocalling;
...
public class VideoActivity extends AppCompatActivity {
   ...
   // private String TWILIO_ACCESS_TOKEN = "";
    ...
    int serviceReqid;
    private static final String TWILIO_ACCESS_TOKEN = "eyJjdHkiOiJ0d2lsaW8tZnBhO3Y9MSIsInR5cCI6IkpXVCIsImFsZyI6IkhTMjU2In0..-LM506TETjrYDJjlEDz2uUgmxOCgmvi-LE06YSligm0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("");
        if (getIntent() != null) {
            //TWILIO_ACCESS_TOKEN = getIntent().getStringExtra("USERACCESSTOKEN");
            // TWILIO_ACCESS_TOKEN = getIntent().getStringExtra(PSRConstants.TWILIO_ACCESS_TOKEN);
            //  TWILIO_ROOM_NAME = getIntent().getStringExtra(PSRConstants.TWILIOROOMNAME);
            serviceReqid = getIntent().getIntExtra("SERVICEREQID", 0);
        ...
        callStatusTv = findViewById(R.id.video_status_textview);
        ...
        if (PSRUtils.isOnline(this)) {
           /* new java.util.Timer().schedule(
                    new java.util.TimerTask() {
                        ...
                        public void run() {
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    //your code
                                   // connectToRoom("PicstarLiveVideo_2580");
                                    connectToRoom("PicstarLiveVideo_"+serviceReqid);
                                    Log.d("ROOMID", "PicstarLiveVideo_"+serviceReqid);
                                }
                            });
                        }
                    },
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    connectToRoom("PicstarLiveVideo");
                   // connectToRoom("PicstarLiveVideo_"+serviceReqid);
                    Log.d("ROOMID", "PicstarLiveVideo_"+serviceReqid);
                }
            }, 5000);
    ...
    private void connectToRoom(String roomName) {
        ...
        callStatusTv.setText("Connecting");
        setDisconnectAction();
    ...
    private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onReconnecting(@NonNull Room room, @NonNull TwilioException twilioException) {
                ...
                callStatusTv.setText("Reconnecting");
            }

            @Override
            public void onReconnected(@NonNull Room room) {
                reconnectingProgressBar.setVisibility(View.GONE);
                callStatusTv.setText("Reconnected");
            }
            ...
            public void onDisconnected(Room room, TwilioException e) {
                ...
                callStatusTv.setText("Disconnected");
