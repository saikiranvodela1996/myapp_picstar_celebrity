...
public class VideoRecordingActivity extends Activity {
    ...
    public static int VIDEO_CAPTURE = 101;
...
//        PreferenceManager.setDefaultValues(this, R.xml.preferences, false); // initialise any unset preferences to their default values
        ...
        orientationEventListener = new OrientationEventListener(this) {
            ...
            public void onOrientationChanged(int orientation) {
                VideoRecordingActivity.this.mainUI.onOrientationChanged(orientation);
            }
        };
        if (MyDebug.LOG)
        ...
        decorView.setOnSystemUiVisibilityChangeListener
                (new View.OnSystemUiVisibilityChangeListener() {
                    ...
                    public void onSystemUiVisibilityChange(int visibility) {
                        ...
                        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(VideoRecordingActivity.this);
        ...
        new Thread(new Runnable() {
            public void run() {
                textToSpeech = new TextToSpeech(VideoRecordingActivity.this, new TextToSpeech.OnInitListener() {
                    @Override
    ...
    private final BroadcastReceiver cameraReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            VideoRecordingActivity.this.takePicture(false);
        }
    };
...
//        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED);
    ...
    public void updateGalleryIcon() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                ...
                Bitmap thumbnail = null;
                KeyguardManager keyguard_manager = (KeyguardManager) VideoRecordingActivity.this.getSystemService(Context.KEYGUARD_SERVICE);
    ...
    private void openGallery() {
        ...
        if (uri != null && !VideoRecordingActivity.useScopedStorage()) {
            // check uri exists
    ...
    public static class MyFolderChooserDialog extends FolderChooserDialog {
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            VideoRecordingActivity main_activity = (VideoRecordingActivity) this.getActivity();
    ...
    private void openFolderChooserDialog() {
        ...
        if (VideoRecordingActivity.useScopedStorage()) {
    ...
    private String getHumanReadableSaveFolder(String save_folder) {
        if (applicationInterface.getStorageUtils().isUsingSAF()) {
            ...
            if (VideoRecordingActivity.useScopedStorage() && save_folder.length() == 0) {
                save_folder = "DCIM";
            }
        }
        return save_folder;
    ...
    private class MyGestureDetector extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            try {
                ...
                final ViewConfiguration vc = ViewConfiguration.get(VideoRecordingActivity.this);
    ...
    public void onVideoRecorded(Uri uri, String fileName) {
        ...
        try {
            ...
            resultIntent.putExtra("VIDEO_URI", uri.toString());
            resultIntent.putExtra("VIDEO_PATH", fileName);
...
/*
    void initialiseExoplayer(Uri videoUri){
        playerView.setVisibility(View.VISIBLE);
        //  Uri uri=Uri.parse();
        String path= PSRUtils.getPath(this,videoUri);
        Uri  uri=Uri.parse(path);
        // Uri videoUrl = Uri.parse("https://s3.us-west-2.amazonaws.com/picstar/thumbnails_new/D5560B1B-5498-4783-855C-A6FA3918C716-17723-00001B9548971901.MOV");
        ...
        //  simpleExoPlayer = ExoPlayerFactory.newSimpleInstance(VideoRecordingActivity.this, trackSelector, loadControl);

        DefaultHttpDataSourceFactory factory = new DefaultHttpDataSourceFactory("exoplayer_video");

        ExtractorsFactory extractorsFactory = new DefaultExtractorsFactory();
      *//*  MediaSource mediaSource = new ExtractorMediaSource(videoUri, factory,
