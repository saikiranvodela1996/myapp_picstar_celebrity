...
public class ScriptC_process_avg extends ScriptC {
    ...
    public void forEach_compute_diff(Allocation ain, Allocation aout, LaunchOptions sc) {
        // check ain
    ...
    public void forEach_avg_multi(Allocation ain, Allocation aout, LaunchOptions sc) {
        // check ain
        if (!ain.getType().getElement().isCompatible(__U8_4)) {
            throw new RSRuntimeException("Type mismatch with U8_4!");
        }
